...
def tristimulus_values(theta, phi, biref, z, E0):
    ...
    X = integrate.trapz(colorfunc.xbar*I, colorfunc.wavelength)
    Y = integrate.trapz(colorfunc.ybar*I, colorfunc.wavelength)
    Z = integrate.trapz(colorfunc.zbar*I, colorfunc.wavelength)
