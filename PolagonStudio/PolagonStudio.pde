...
// cd into backend and run python3 polagon_service.py
...
void load_mosaic1(){
  ...
  if (first_design_file!=null && !editD1 && !first_loaded){
    ...
    if (maskset) {
      firstmainviews.add(firstmainviews.get(0).copy_img(this, true, imgplace.get(2), 300, first_inverted, true));
      firstmainviews.add(firstmainviews.get(1).copy_img(this, true, imgplace.get(2), 700, !first_inverted, true));
...
void load_mosaic2(){
  if (second_design_file!=null && !editD2 && !second_loaded){
    ...
    if (maskset){
      secondmainviews.add(secondmainviews.get(0).copy_img(this, true, imgplace.get(3), 300, second_inverted, true));
      secondmainviews.add(secondmainviews.get(1).copy_img(this, true, imgplace.get(3), 700, !second_inverted, true));
